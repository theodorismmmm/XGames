  ...
  <g transform="matrix(0.19536555,-0.08235951,0.08235951,0.19536555,191.47,189.14735)" id="g5" style="fill: #7711ff; fill-opacity: 1">
    <g id="g4" style="fill: #7711ff; fill-opacity: 1">
      ...
      <path class="st0" d="m 331.9,56.7 32.6,79.8 c 2.5,6.2 8,10.1 14.6,10.6 l 86,6.4 c 14.2,1 25.7,10.1 30.1,23.6 4.4,13.5 0.4,27.6 -10.5,36.8 l -65.9,55.7 c -5.1,4.3 -7.2,10.7 -5.6,17.2 l 20.5,83.8 c 3.4,13.8 -1.6,27.6 -13.2,35.9 -11.5,8.4 -26.1,8.9 -38.2,1.4 l -82.4,-51 -82.4,51 c -12.1,7.5 -26.7,7 -38.2,-1.4 -11.5,-8.4 -16.5,-22.1 -13.2,-35.9 l 20.5,-83.8 c 1.6,-6.5 -0.5,-12.9 -5.6,-17.2 l -65.9,-55.7 c -10.9,-9.2 -14.9,-23.3 -10.5,-36.8 4.4,-13.5 15.9,-22.6 30.1,-23.6 l 86,-6.4 c 6.7,-0.5 12.1,-4.4 14.6,-10.6 l 32.6,-79.8 c 5.4,-13.2 17.5,-21.3 31.8,-21.3 14.7,-0.1 26.8,8.1 32.2,21.3 z" style="
       ...
       <!-- <span class="navbar-title">GameSpaces</span> -->
    </div>
    <div class="navbar-links">
        <a href="/" class="navbar-link"><span class="icon" aria-hidden="true"><i class="fas fa-home"></i></span> <p class="navbar-text">Startseite</p></a>
        <a href="/science" class="navbar-link"><span class="icon" aria-hidden="true"><i class="fas fa-gamepad"></i></span> <p class="navbar-text">Spiele</p></a>
        <a href="/ai" class="navbar-link"><span class="icon" aria-hidden="true"><i class="fas fa-robot"></i></span> <p class="navbar-text">KI</p></a>
        <a href="/math" class="navbar-link"><span class="icon" aria-hidden="true"><i class="fas fa-grid-2"></i></span> <p class="navbar-text">Apps</p></a>
        <a href="/settings" class="navbar-link"><span class="icon" aria-hidden="true"><i class="fas fa-cog"></i></span> <p class="navbar-text">Einstellungen</p></a>
        <a href="/more" class="navbar-link"><span class="icon" aria-hidden="true"><i class="fas fa-plus"></i></span> <p class="navbar-text">Mehr</p></a>
    </div>
</nav>
`;
